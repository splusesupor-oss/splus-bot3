...
backup = Path("handlers/message_handler.before_emergency_fix.py")

shutil.copy(p, backup)

text = p.read_text(encoding="utf-8")

# فقط ابتدای خراب را تعمیر می‌کنیم
pos = text.find("async def get_group_admins_info")
...
p.write_text(top + rest, encoding="utf-8")

print("✅ emergency fixed")
print("backup:", backup)
