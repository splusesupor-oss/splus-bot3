...
from modules.group_stats import add_message, make_report
from modules.group_stats import add_kick
from modules.group_stats import add_mute
...
from modules.group_stats import add_message, add_kick, add_mute, add_kick, add_mute
from modules.banned_storage import remove_banned
from modules.admin_storage import add_admin, is_admin, remove_admin
...
async def handle_new_message(bot, event):
    ...
    try:
        ...
        auto_replies = {
            ...
            "عاشقتم": "منم عاشقتم🦊",
            "عشقم": "جونم ❤️",
            "دلم گرفته": "الهی غمت نباشه ❤️",
            "چه خبر": "سلامتی، تو چه خبر؟ 🌹",
            "چخبر": "سلامتی، تو چه خبر؟ 🌹",
            "خستم": "یه کم استراحت کن، درست میشه 🌸",
            "بای": "فعلاً، مواظب خودت باش 👋",
            "شب خوش": "شب آرومی داشته باشی 🌙",
            "صبح بخیر": "صبح تو هم بخیر ☀️",
            "مرسی": "خواهش می‌کنم 🌹",
            "فعلا": "باشه، فعلاً خداحافظ 👋",
            "بایی": "بایی 👋",
            "شبخوش": "شب خوش 🌙",
            "من برم فعلا": "باشه، موفق باشی 👋",
            "چطوری خوبی": "خوبم، مرسی 😊",
            "سلام خوبی": "سلام، خوبم ممنون 🌹",
            "حالت چطوره": "خوبم، تو چطوری؟ 😊",
            "کصخل": "ادب از که یاد گرفتی؟ از بچه‌های سروش 😏",
            "کسخل": "ادب از که یاد گرفتی؟ از بچه‌های سروش 😏",
            "لاشی": "ادب از که یاد گرفتی؟ از بچه‌های سروش 😏",
            "کونی": "ادب از که یاد گرفتی؟ از بچه‌های سروش 😏",
            "کونده": "ادب از که یاد گرفتی؟ از بچه‌های سروش 😏",
            "گوه بخور": "ادب از که یاد گرفتی؟ از بچه‌های سروش 😏",
            "کثافت": "ادب از که یاد گرفتی؟ از بچه‌های سروش 😏",
            "عوضی": "ادب از که یاد گرفتی؟ از بچه‌های سروش 😏",
            "اشغال": "ادب از که یاد گرفتی؟ از بچه‌های سروش 😏"
        }
...
"جستجو اسم مطلبی که می‌خواهید بدانید\n\n"
                ...
                "🔤 فیلتر کلمات گروه:\n"
                  ...
                  "!اسم نام جدید گروه\n\n"
                "🛡️ حالت سختگیرانه:\n"
                "خاموش کردن حالت سختگیرانه:\n"
                "لغو کلمات ممنوعه\n\n"
                "فعال سازی حالت سختگیرانه:\n"
                "فعال کلمات ممنوعه\n\n"
...
# سکوت کاربر با ریپلای
        ...
        try:
            ...
            print("خطای تشخیص فوروارد:", e)
                                ...
                                ids = bot.spammer_messages[user_id][:]
                                if ids:
            ...
            try:
                ...
                if repeat_spam:
                    ...
                    if hasattr(bot.admin_actions, "ban_user"):
                        print(f"🚨 BAN FROM REPEAT_SPAM | chat={chat_id} user={user_id}")
