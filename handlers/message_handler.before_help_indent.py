from modules.fill_blank import new_fill
from modules.banned_storage import remove_banned
from modules.riddles import get_answer
from modules.font_converter import make_fonts
from modules.group_storage import activate_group
from modules.group_stats import add_kick
from modules.group_storage import deactivate_group
...
from modules.admin_storage import add_admin
from modules.admin_storage import remove_admin
...
async def handle_new_message(bot, event):
    ...
    try:
        ...
        # اطلاعات پیام        sender = await event.get_sender()
